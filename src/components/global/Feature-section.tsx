      ...
      <div className="container">
        <div className="max-w-[664px] mx-auto mb-[34px]">
          ...
          <p className="text-center text-base md:text-[20px] text-[#666666] font-Inter md:leading-7">
            Healfy&apos;s voice assistants offer patients quick, automated self-service options
            whenever they contact your healthcare practice.
          </p>
        </div>
            ...
            <div className="relative w-full">
              ...
              {!isPlaying && (
                <div className="absolute inset-0 flex items-center justify-center">
                  ...
                  >
                    <Image src={PlayButton.src} width={100} height={100} alt={activeTab.label} />
                  </button>
                </div>
              )}
            </div>
